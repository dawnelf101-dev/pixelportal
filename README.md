...
2. **"Start" drücken:** Die App öffnet den lokalen Port `19132` auf dem Smartphone.
3. **Im Spiel finden:** Die PS5/Xbox erkennt die App automatisch im Minecraft-Menü unter **Freunde → LAN-Spiele**.
4. **Verbinden:** Die Konsole verbindet sich mit dem Smartphone, welches ein *Transfer Packet* mit der Ziel-IP sendet.
5. **Direktverbindung:** Die Konsole baut die Verbindung **DIREKT** zum Ziel-Server auf.
6. **Fertig:** Die App kann danach geschlossen werden — die Serververbindung bleibt bestehen.
